...
<div class="dom">
<center><span class="titl">Gallery</span></center>
            ...
            <?php
				...
				if(mysql_num_rows($query))
				{
					while($data=mysql_fetch_assoc($query))
					{
						...
						echo ' <img data-u="image" style="width:100px" src="img/'.$data['file'].'" />';
						
						echo '<img data-u="thumb" src="img/'.$data['file'].'" />';
				...
				{
					echo 'There is no images in gallery.';
				}
            ?>
