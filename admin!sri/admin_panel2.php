	...
	<div class="head">
		<center>
			<ul id="nav">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							<ul id="up">	
								...
								<li><a href="gallery_panel.php" target="ifrDame">Gallery</a></li>
								<li><a href="admin_data.php" target="iframe">Admin data</a></li>
							</ul>
						</div>
					</div>
				</li>
				<li>
					<div class="dropdown">
						<a href="#" class="main2">Student Details</a>
						<div class="dropdown-content">
							<ul id="up">	
								<li><a href="btech_panel.php" target="iframe">Btech</a></li>
								<li><a href="mtech_panel.php" target="iframe">Mtech</a></li>
								<li><a href="phd_panel.php" target="iframe">Phd</a></li>
							</ul>
						</div>
					</div>
				</li>
				<li>
					<div class="dropdown">
						<a href="#" class="main2">Del</a>
						<div class="dropdown-content">
							<ul id="up">	
								<li><a href="class_del.php" target="iframe">Class</a></li>
								<li><a href="filetype_del.php" target="iframe">File type</a></li>
