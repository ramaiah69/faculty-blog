...
<?php
		...
		$id=1;
		$query=mysql_query("select * from  phd");
			while($data=mysql_fetch_assoc($query))
			{
					...
					else
					{
						...
						echo '<td><a href="student_edit.php?id='.$data['id'].'&type=phd&year='.$data['year'].'" target="_blank">Edit</a></td>';
						echo '<td id="del">';
						echo '<a href="#" onClick="del2('."'".$data['id']."','phd',".$data['year'].')" >Delete</a></td></tr>';
